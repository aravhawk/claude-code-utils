...
- Keep project details and learned codebase rules up to date using the same rule: update both if present, otherwise only the one that exists, or neither if none exist.
